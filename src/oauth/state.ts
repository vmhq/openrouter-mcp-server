 ...
 *
 * Owns the registered clients, single-use authorization codes, pending
 * PocketID transactions, and access-token hash maps, plus their atomic JSON
 * persistence. Side effects (initial load and the hourly prune interval) run
 * at module load.
 */
